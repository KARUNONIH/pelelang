            ...
            <ul class="space-y-2">
                ...
                <li>
                    <button type="button"
                        ...
                        <span class="flex-1 ml-3 text-left whitespace-nowrap">Cek Lelang</span>
                    ...
                    <ul id="dropdown-example" class="hidden m-2 bg-gray-700 rounded-xl">
                        <li>
                            <a href="{{ route('user.cek') }}"
                                class="flex items-center w-full p-3 text-base font-normal text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-900"><i
                                    class="fa-solid fa-gavel mr-2"></i>Dalam proses</a>
                        </li>
                        <li>
                            <a href="{{ route('user.history') }}"
                                class="flex items-center w-full p-3 text-base font-normal text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-900"><i
                                    class="fa-solid fa-circle-check mr-2"></i>Bid berhasil</a>
                        </li>
                    </ul>
                </li>
                        ...
                        <li>
                            <form method="POST" action="{{ route('logout') }}">
                                ...
                                <x-dropdown-link :href="route('logout')"
                                   ...
                                   <i
                                   class="fa-solid fa-circle-check mr-2"></i>
                                    <p class="text-white">Logout</p>
                                </x-dropdown-link>
                            </form>
                            {{-- <a href="{{ route('logout')}}"
                                class="flex items-center w-full p-3 text-base font-normal text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-900"><i
                                    class="fa-solid fa-circle-check mr-2"></i>Log out</a> --}}
                        </li>
                    </ul>
                </li>
            </ul>
